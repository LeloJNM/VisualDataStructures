...
def display_stack():
    ...
    push_button = ttk.Button(janela, text="Push", command=push_value)
    push_button.pack(side="left")
    push_button.place(x=50, y=200)
    ...
    peek_button = ttk.Button(janela, text="Peek", command=peek_value)
    peek_button.pack(side="left")
    peek_button.place(x=50, y=100)
    ...
    def display_elements():
        ...
        count_label.config(text=f"Número de elementos: {len(stack.stack)}/5.")
...
def display_queue():
    ...
    enqueue_front_button = ttk.Button(janela, text="Adicionar no início", command=enqueue_front_value)
    ...
    enqueue_back_button = ttk.Button(janela, text="Adicionar no final", command=enqueue_back_value)
    ...
    dequeue_front_button = ttk.Button(janela, text="Remover do início", command=dequeue_front_value)
